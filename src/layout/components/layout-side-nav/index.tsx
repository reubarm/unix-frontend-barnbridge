      ...
      <aside className={cn(s.aside, { [s.expanded]: navOpen, [s.open]: navOpen })}>
        <div className={s.logoContainer}>
          ...
          <Link to="/" className={s.logo}>
            <img src="/fav.png" alt="Unix Icon" className={s.unixIcon} />
            <img src="/unix.png" alt="Unix Logo" className={s.unixLogo} />
          </Link>
        </div>
        <nav className={s.top}>
          {features.faucets && (
          ...
          {features.smartYield && (
            <NavLink to="/smart-yield" className={s.button} activeClassName={s.active}>
              ...
              <div className={s.btnContent}>
                <Text type="lb2" weight="bold" className={s.btnLabel} color="unix">
                  SMART
                </Text>
                <Text type="lb1" weight="semibold" className={s.btnText}>
                  Yield
